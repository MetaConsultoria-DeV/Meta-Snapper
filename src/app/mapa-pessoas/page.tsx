...
import { ORG, tipoMeta, type OrgNode as OrgNodeT, type OrgCelula, type OrgNodeType } from "@/lib/org-data";
        ...
        <>
          <div className="org-stage">
            <div className="org-stage__head">
              ...
              <img className="org-stage__mascot" src={`/brand/mascots/${cel.mascot}.png`} alt={cel.nome} />
              <div>
            ...
            <div className="org-tabs">
              {ORG.celulas.map((c) => (
                <div key={c.id} className={"org-tab" + (celAtiva === c.id ? " active" : "")} onClick={() => setCelAtiva(c.id)}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={`/brand/mascots/${c.mascot}.png`} alt="" />
                  {c.nome}
                </div>
              ))}
            </div>
          ...
          {ORG.celulas.map((c) => (
            ...
            >
              <div className="flex items-center gap-3">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={`/brand/mascots/${c.mascot}.png`} alt="" style={{ width: 54, height: 54, objectFit: "contain" }} />
                <div>
