                ...
                return (
                  <div key={i}>
                    <div className="mb-1 flex items-center justify-between text-[12.5px]">
                      <span className="flex items-center gap-2 min-w-0"><span className="size-2.5 rounded-[3px] flex-shrink-0" style={{ background: c.color }} /><span className="truncate">{c.nome}</span></span>
